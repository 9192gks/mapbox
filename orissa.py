...
# Import data 
median_price_new = pd.read_csv('orissa.csv')

with open('orissa.geojson') as json_data:
    Sydney_data = json.load(json_data)

# mapbox token
mapbox_accesstoken = 'Enter your access token'

# This is the part to create plotly fig
########################################################
suburbs=median_price_new['Location of Monitoring Station'].str.title().tolist()
print(suburbs)
...
Types = ['SO2','NO2','RSPM/PM10','PM 2.5']    
